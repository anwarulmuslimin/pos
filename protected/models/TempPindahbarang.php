...
/**
 * This is the model class for table "temp_pindahbarang".
 *
 * The followings are the available columns in table 'temp_pindahbarang':
 * @property string $tgl
 ...
 */
class TempPindahbarang extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('nota', 'length', 'max'=>40),
			array('jam', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('tgl, kode, jml, barang, toko, user, jam, alamat, telp, nota, h_jual', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TempPindahbarang the static model class
	 */
