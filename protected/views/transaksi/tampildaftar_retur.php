<table class="table table-condensed table-hover" width="100%">
    <tr>
        ...
        <th>Jumlah</th>
        <th>Alasan</th>
        <th colspan="2"> <input type="checkbox" name="pilihsemua" id="pilihsemua"></th>
    </tr>
    <? $urut=1;?>
    ...
    <tr>
        ...
        <td><a onclick="batal_retur(<?=$urut; ?>);" class="btn btn-flat btn-danger btn-sm"><i class="fa fa-remove"></i> batal</a></td>
    </tr>
    <? $urut++;?>
    <?}?>
</table>
...
<? if($urut > 1){?>
    <a href="javascript::proses" onclick="proses_returjual();" class="btn btn-bni"><i class="fa fa-check"></i> proses retur</a>
<?}?>
